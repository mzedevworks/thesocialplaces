...
jQuery(document).ready(function($){
	...
	if($('a.language-change').length){
	$("a.language-change").click(function () {
		//Active Class
		if($(this).attr('id') == 'language-active'){
			$('#header-languages').slideDown();
			$('#header-languages').addClass('no-language-active');
			$(this).attr('id','no-language-active');
		}else{
			$('#header-languages').slideUp();
			$('#header-languages').removeClass('no-language-active');
			$(this).attr('id','language-active');
		}
	});
	}
	...
	if($('a.cross-languages').length){
	$("a.cross-languages").click(function () {
		//Active Class
		$('#no-language-active').attr('id','language-active');
		$('#header-languages').slideUp();
	});
			}
